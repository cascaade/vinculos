...
export default function Contacto() {
    ...
    return (<article className={styles.contacto} id="_contacto">
        ...
        <form action="" method="POST" className={styles.form} ref={formRef} onSubmit={(e) => { e.preventDefault(); alert("¡guau!") }}>
            ...
            <input type="tel" name="" id="" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="teléfono" onInvalid={(e) => (e.target as HTMLInputElement).setCustomValidity("Ingresa un número de teléfono, por ejemplo: 123-456-7890")}
            ...
            <Boton fill="main" className={styles.button} onclick={() => formRef.current?.requestSubmit()}>Enviar</Boton>
        </form>
    </article>);
}
