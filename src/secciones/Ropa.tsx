...
export default function Ropa() {
    return (<article className={styles.ropa}>
        ...
        <p>Tenemos un catálogo increíble de estilos y conjuntos. Contamos con una selección de más de 50 vestidos, 20 trajes y más de 100 prendas para todos los momentos de la celebración.</p>
