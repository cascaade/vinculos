...
export default function Negocio() {
    return (<article className={styles.negocio} id="_negocio">
        ...
        <p>Con más de 8 años de experiencia, hemos diseñado y coordinado 164 bodas, con más de 43,173 invitados en celebraciones muy bonitas. Nuestro trabajo se basa en cuidar los detalles, ofrecer buen diseño y crear un proceso simple de principio a fin.</p>
